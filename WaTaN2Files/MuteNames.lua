...
if DevAbs:get(WaTaNTeaM.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(WaTaNTeaM.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(WaTaNTeaM.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(WaTaNTeaM.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(WaTaNTeaM.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(WaTaNTeaM.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
WaTaNTeaMName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if WaTaNTeaMName then 
WaTaNTeaMNames = DevAbs:smembers(WaTaNTeaM.."Abs:Mute:Names"..msg.chat_id_) or ""
if WaTaNTeaMNames and WaTaNTeaMNames[1] then 
for i=1,#WaTaNTeaMNames do 
if WaTaNTeaMName:match("(.*)("..WaTaNTeaMNames[i]..")(.*)") then 
...
DevAbs:set(WaTaNTeaM.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(WaTaNTeaM.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
