...
if result.id_ then 
local abbs = DevAbs:get("WaTaNTeaMTEAM:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevAbs:del("WaTaNTeaMTEAM:Name"..result.id_) 
end
end
...
DevAbs:set("WaTaNTeaMTEAM:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
